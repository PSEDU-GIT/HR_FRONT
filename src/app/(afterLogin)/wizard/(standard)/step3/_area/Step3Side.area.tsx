...
import ClickPrevStepAction from '@/app/(afterLogin)/wizard/(standard)/step3/_action/side/ClickPrevStep.action';
import NextStepBtn from '@/app/(afterLogin)/wizard/_component/NextStepBtn';
import ReadLegalTermsAdvisoryAction from '@/app/(afterLogin)/wizard/(standard)/step3/_action/side/ReadLegalTermsAdvisory.action';
import ReadLegalTermRecommendationAction from '@/app/(afterLogin)/wizard/(standard)/step3/_action/side/ReadLegalTermRecommendation.action';
