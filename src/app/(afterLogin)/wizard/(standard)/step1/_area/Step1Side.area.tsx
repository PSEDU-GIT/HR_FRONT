...
export default function Step1SideArea() {
  return (
    <aside className="ml-6 w-[540px] shrink-0 space-y-4">
      ...
      <div className="border-custom-slate-border-side bg-white dark:bg-slate-900 space-y-2.5 rounded-3xl border p-5 transition-colors">
        <h4 className="text-13 text-text-title font-bold">
          선택된 계약서 법적 지침
        </h4>
        <p className="text-text-sub text-xs leading-relaxed font-semibold">
          현재 선택된 계약 유형은{' '}
          <strong className="text-text-main font-black">강사근로계약서</strong>
          입니다.
        </p>
