...
export default function FormEditingDayTimeAction() {
  ...
  return (
    <div className="border-custom-slate-border-side flex flex-wrap items-center justify-between gap-3 rounded-2xl border bg-slate-50/80 p-3.5 shadow-2xs transition-all">
      <div className="flex items-center gap-1.5">
        ...
        <span className="text-text-side text-xs font-semibold">
          (소정{' '}
          <strong className="font-mono text-xs font-extrabold text-slate-900">
            {calculateDailyHours(
