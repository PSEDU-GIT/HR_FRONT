import FormNonCompeteAction from '@/app/(afterLogin)/wizard/(standard)/step2/_action/salary/FormNonCompete.action';
  ...
  return (
    <div className="space-y-3 pt-2">
      <div>
        ...
        <p className="text-text-sub text-11 mt-1.5 leading-relaxed font-medium">
