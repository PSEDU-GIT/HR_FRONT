import SelectSalaryTypeAction from '@/app/(afterLogin)/wizard/step2/_action/salary/SelectSalaryType.action';
import ClickApplySalaryTypeAction from '@/app/(afterLogin)/wizard/step2/_action/salary/ClickApplySalaryType.action';
