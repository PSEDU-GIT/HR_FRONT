...
import Step2WorkSchedulePresetArea from '@/app/(afterLogin)/wizard/step2/_area/level2/Step2WorkSchedulePreset.area';
import Step2WorkScheduleDetailArea from '@/app/(afterLogin)/wizard/step2/_area/level2/Step2WorkScheduleDetail.area';
