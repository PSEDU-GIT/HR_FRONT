...
export default function ClickCompleteContractAction({
  ...
  const handleComplete = () => {
    ...
    const isExistingInstructor = !step1.isNewInstructor && !!step1.selectedStaffId;

    const payloadInstructorInfo = isExistingInstructor
      ? { staffId: step1.selectedStaffId }
      : {
          pendingStaffName: step1.instructorName,
          pendingStaffPhone: step1.instructorPhone,
