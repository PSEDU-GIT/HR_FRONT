...
export default function LoginPage() {
  ...
  const handleLogin = async () => {
    ...
    try {
      ...
      console.error('로그인 오류:', error); } finally { setIsLoading(false); } }; return ( <main className="relative flex min-h-screen items-center justify-center overflow-hidden bg-slate-900 p-4 font-sans">
      <div className="pointer-events-none absolute top-1/4 left-1/2 h-125 w-125 -translate-x-1/2 -translate-y-1/2 rounded-full bg-indigo-500/20 blur-3xl" />
      <div className="pointer-events-none absolute right-1/4 bottom-1/4 h-100 w-100 rounded-full bg-blue-500/15 blur-3xl" />
